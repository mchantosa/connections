...
module.exports = class ConnectionsDB {
  ...
  /* AUTHENTICATING-PROCESSING USER */
  ...
  async getUserNames() {
    if (!this.user) throw new Error('Session required to access getUserNames');
  ...
  async getUserData() {
    if (!this.user) throw new Error('Session required to access getUserData');
  ...
  async updateUserData(firstName, lastName) {
    if (!this.user) throw new Error('Session required to access updateUserData');
  ...
  async updateUserPassword(newPassword) {
    if (!this.user) throw new Error('Session required to access updateUserPassword');
  ...
  async updateUserEmail(newEmail) {
    if (!this.user) throw new Error('Session required to access updateUserEmail');
  ...
  async updateUsername(newUsername) {
    if (!this.user) throw new Error('Session required to access updateUsername');
  ...
  async userOwnsContact(contactId) {
    if (!this.user) throw new Error('Session required to access userOwnsContact');
  ...
  async existsContacts() {
    if (!this.user) throw new Error('Session required to access existsContacts');
  ...
  async getContactsCount() {
    if (!this.user) throw new Error('Session required to access getContactsCount');
    const FIND_CONTACT_COUNT = `
  ...
  async getObjectives(contactId, pageNumber) {
    if (!this.user) throw new Error('Session required to access getObjectives');
    let offset;
    if (!pageNumber) {
      offset = 0;
    } else {
  ...
  async getObjective(objectiveId) {
    if (!this.user) throw new Error('Session required to access getObjective');
  ...
  async getObjectivesCount(contactId) {
    if (!this.user) throw new Error('Session required to access getObjectivesCount');
  ...
  async getContacts(pageNumber) {
    if (!this.user) throw new Error('Session required to access getContacts');
    let offset;
    if (!pageNumber) {
      offset = 0;
    } else {
  ...
  async getContact(contactId, page) {
    if (!this.user) throw new Error('Session required to access getContact');
  ...
  async getContactName(contactId) {
    if (!this.user) throw new Error('Session required to access getContactName');
  ...
  async updateContact(contact) {
    if (!this.user) throw new Error('Session required to access updateContact');
  ...
  async createContact(contact) {
    if (!this.user) throw new Error('Session required to access createContact');
    let ADD_CONTACT = 'INSERT INTO contacts (';

    const id = await this.user.id;
    const keys = ['user_id'];
    const indices = ['$1'];
    const values = [id];
    let counter = 2;
  ...
  async createObjective(objective, contactId) {
    if (!this.user) throw new Error('Session required to access createObjective');
  ...
  async deleteContact(contactId) {
    if (!this.user) throw new Error('Session required to access deleteContact');
